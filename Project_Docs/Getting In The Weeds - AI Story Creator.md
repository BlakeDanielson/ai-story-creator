...
* **Task 1.5 (Dependency Management \- BE):** Choose *definitively* between pip freeze \> requirements.txt vs. Poetry vs. PDM for managing Python dependencies and lock files. Document the chosen process.  
